...
pinecone.init(api_key=settings.pinecone_api_key, environment=settings.pinecone_env_name)

vector_store = Pinecone.from_existing_index(settings.pinecone_index_name, embeddings)
